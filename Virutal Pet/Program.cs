...
{
    internal class VirutuellPokémon
    {
        private string navn;
        private int alder;
        ...
        public VirutuellPokémon(string navn, int alder, int sultnivå = 10, int kosnivå = 5, int donivå = 6)
        {
            this.navn = navn;
            this.alder = alder;
    ...
    class Program
    {
        static void Main()
        {
            Console.WriteLine("Du har 3 Pokémon: Treeko, Mudkip og Torchic");
            Console.WriteLine("Hvilken pokémon vil du ta vare på?");
            string navn = Console.ReadLine();

            VirutuellPokémon p1 = new VirutuellPokémon("Treeko", 1);
            VirutuellPokémon p2 = new VirutuellPokémon("Mudkip", 3, 2);
            VirutuellPokémon p3 = new VirutuellPokémon("Torchic", 3, 2, 0, 2);
            VirutuellPokémon pokémon;
            bool avslutt = false;

            while (!avslutt)
            {
                if (navn == "Treeko") { pokémon = p1; }
                else if (navn == "Mudkip") { pokémon = p2; }
                else if (navn == "Torchic") { pokémon = p3; }
                else
                {
                    break;
                }
